...
char* (*mnemonics[INSTR_MAX]) (const int opcode) = { 
    ...
    mnem_brpl, mnem_brlo, mnem_brlt, mnem_brcc, mnem_brcs, mnem_brvs, mnem_brts, mnem_brmi, mnem_rcall, mnem_ret, mnem_icall, mnem_cp, mnem_cpi, 
    mnem_cpc, mnem_lsr, mnem_asr, mnem_ror, mnem_swap, mnem_ori, mnem_or_asm, mnem_and_asm, mnem_andi, mnem_com, mnem_bld, mnem_bst, mnem_ses, 
